...
const char* password     = "YOUR-SECRET-WIFI-PASSWORD"; // Wi-Fi Password
   ...
   if((WiFi.status() == WL_CONNECTED)) {
        ...
        if(httpCode > 0) {
            if(httpCode == HTTP_CODE_OK) {
                ...
                String command1 = "ads.txt=\"" + String(dns_queries_today) + "\"";
                ...
                endNextionCommand();
                delay(10);
                String command4 = "blocked.txt=\"" + String(ads_blocked_today) + "\"";
                Serial.print(command4);
                endNextionCommand();
                delay(10);
                
                if (String(status_pihole) == "enabled") {
                   String command5 = "status.pic=2";
                   Serial.print(command5);
                   endNextionCommand();
                   delay(10);
                   String command6 = "status.txt=\"" + String(timeClient.getFormattedTime()) + "\"";
                   ...
                   String command7 = "status.pic=1";
                   Serial.print(command7);
                   endNextionCommand();
                   delay(10);
                   String command8 = "status.txt=\"" + String(timeClient.getFormattedTime()) + "\"";
                ...
                http.end();
                   ...
                   String command9 = "status.txt=\"No WiFi\"";
